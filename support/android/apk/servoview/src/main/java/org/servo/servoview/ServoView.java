...
public class ServoView extends SurfaceView
    ...
    public String kotisatamaSearch(String query) {
        if (servo != null) {
            return servo.kotisatamaSearch(query);
        }
    ...
    public String kotisatamaSubmitReport(String kind, String domain, String message, String contextUrl) {
        if (servo != null) {
            return servo.kotisatamaSubmitReport(kind, domain, message, contextUrl);
        }
    ...
    public boolean kotisatamaShouldShowReport(String currentUrl) {
        if (servo != null) {
            return servo.kotisatamaShouldShowReport(currentUrl);
        }
